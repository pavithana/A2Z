...
jQuery(document).ready(function($) {
    // Fix for the "Rapid Solutions" section - ensure it's visible
    setTimeout(function() {
        $('.bt_bb_section.bt_bb_color_scheme_1[style*="background-color:#222222"]').each(function() {
            $(this).css({
                'display': 'block',
                'visibility': 'visible',
                'opacity': '1'
            ...
            // Make sure the background image column is visible
            $(this).find('.bt_bb_column.btLazyLoadBackground').each(function() {
